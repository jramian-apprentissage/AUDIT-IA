...
SET questions_generees = '{
  "questions": [
    ...
    "[Bloc 5 — Paie · 8 min] La paie (8h/semaine, sur Excel) — décrivez-moi ce process de A à Z, jusqu''à l''envoi à l''expert-comptable.",
    "[Bloc 5] Mathieu a proposé de tester la génération automatique de 3 à 5 fiches de paie pour les comparer à celles du comptable — qu''est-ce que vous en pensez ? Qu''est-ce qui vous semble le plus risqué à automatiser dans ce process ?",
